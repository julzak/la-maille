...
export const translations = {
  fr: {
    ...
    hatNeedles: "circulaire courte 40 cm ou doubles pointes",
    hatFinishedLabel: "cm de tour (bonnet)",
    ...
    "garment.bonnet": "Bonnet",

    // Bonnet
    "hat.brim": "Bord",
    "hat.brim.cotes-1x1": "Côtes 1/1",
    "hat.brim.cotes-2x2": "Côtes 2/2",
    "hat.brim.mousse": "Point mousse",
    "hat.brim.roule": "Roulé",
    "hat.brim.unknown": "Non identifié",
    "hat.folded": "à revers",
    "hat.shape": "Forme",
    "hat.shape.ajuste": "Ajusté",
    "hat.shape.ample": "Ample",
    "hat.shape.unknown": "Non identifiée",
    "hat.crown": "Sommet",
    "hat.crown.quartiers": "En quartiers",
    "hat.crown.spirale": "En spirale",
    "hat.crown.fronce": "Froncé",
    "hat.crown.unknown": "Non identifié",
    "hat.pompom": "Pompon",
    "hat.pompom.yes": "Oui",
    "hat.pompom.no": "Non",
    "hat.pompom.unknown": "Non visible",
    hatPickSize: "Choisissez le tour de tête",
    hatHeadLabel: "cm tour de tête",
    hatMeasurementsTitle: "Mesures du bonnet",
    hatHeadCircumference: "Tour de tête (cm)",
    hatHeadHelp: "Mesuré autour du front, au-dessus des oreilles.",
    hatHeight: "Hauteur du bonnet (cm)",
    hatHeightHelp: "Porté, du bas du bord au sommet. Repère : du sommet de la tête au bas de l'oreille.",
    hatBrimHeight: "Hauteur du bord (cm)",
    hatBrimHelp: "Bord visible. Un bord à revers est tricoté deux fois plus haut.",
    hatEase: "Aisance négative (%)",
    hatEaseHelp: "Le bonnet est plus petit que la tête pour bien tenir. 12 % est la valeur courante.",
    hatSizeSource: "Tailles : tours de tête moyens par âge (Woolly Wormhead).",
    ...
    toastRegenerated: "Patron mis à jour",
    projectStepAnalysis: "Analyse en cours",
    projectStepMeasurements: "Mesures en cours",
    projectStepPattern: "Patron généré",
  ...
  en: {
    ...
    hatNeedles: "short 16 in / 40 cm circular or double-pointed",
    hatFinishedLabel: "cm around (hat)",
    ...
    // Hat
    "hat.brim": "Brim",
    "hat.brim.cotes-1x1": "1x1 rib",
    "hat.brim.cotes-2x2": "2x2 rib",
    "hat.brim.mousse": "Garter stitch",
    "hat.brim.roule": "Rolled",
    "hat.brim.unknown": "Not identified",
    "hat.folded": "folded",
    "hat.shape": "Shape",
    "hat.shape.ajuste": "Fitted",
    "hat.shape.ample": "Slouchy",
    "hat.shape.unknown": "Not identified",
    "hat.crown": "Crown",
    "hat.crown.quartiers": "Wedge sections",
    "hat.crown.spirale": "Swirl",
    "hat.crown.fronce": "Gathered",
    "hat.crown.unknown": "Not identified",
    "hat.pompom": "Pompom",
    "hat.pompom.yes": "Yes",
    "hat.pompom.no": "No",
    "hat.pompom.unknown": "Not visible",
    hatPickSize: "Pick the head size",
    hatHeadLabel: "cm head",
    hatMeasurementsTitle: "Hat measurements",
    hatHeadCircumference: "Head circumference (cm)",
    hatHeadHelp: "Measured around the forehead, above the ears.",
    hatHeight: "Hat height (cm)",
    hatHeightHelp: "As worn, from the bottom of the brim to the top. Guide: from the top of the head to the bottom of the ear.",
    hatBrimHeight: "Brim height (cm)",
    hatBrimHelp: "Visible brim. A folded brim is knitted twice as tall.",
    hatEase: "Negative ease (%)",
    hatEaseHelp: "The hat is smaller than the head so it stays on. 12% is the usual value.",
    hatSizeSource: "Sizes: average head circumference by age (Woolly Wormhead).",
    ...
    toastRegenerated: "Pattern updated",
    projectStepAnalysis: "Analysis in progress",
    projectStepMeasurements: "Measurements in progress",
    projectStepPattern: "Pattern generated",
