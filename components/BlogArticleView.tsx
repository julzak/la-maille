...
/**
 * Rendu partagé d'un article de blog. Servi par /blog/[slug] (EN) et
 * /fr/blog/[slug] (FR) : les liens internes (retour, CTA, articles liés)
 * sont préfixés selon la langue de l'article.
 */
export function BlogArticleView({ slug }: { slug: string }) {
  ...
  const canonicalUrl = `https://la-maille.com${prefix}/blog/${article.slug}`;
